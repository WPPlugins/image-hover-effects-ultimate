...
function iheb_oxi_hov_id_column_content( $ihebcat, $id ) {
	if ( 'iheb-oxi-hov' == $ihebcat ) {
		...
		$shortcode_php_massage = '&lt;?php echo do_shortcode(&#039;' . $shortcode_massage . '&#039;); ?&gt;';
		echo '<input style="min-width:210px" type=\'text\' onClick=\'this.setSelectionRange(0, this.value.length)\' value=\'' . $shortcode_massage . '\' /> <br>';
		echo 'Php Code <input style="min-width:210px" type=\'text\' onClick=\'this.setSelectionRange(0, this.value.length)\' value=\'' . $shortcode_php_massage . '\' /> ';
	}
}
